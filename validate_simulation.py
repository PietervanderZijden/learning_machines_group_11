...
def main():
    ...
    try:
        ...
        if args.task_events:
            ...
            # Food-food and ordinary resting contacts must not count.
            obs, _ = env.reset()
            ...
            # Every discovered food must be collectible exactly once, and an
            # already collected object must not increment the counter again.
