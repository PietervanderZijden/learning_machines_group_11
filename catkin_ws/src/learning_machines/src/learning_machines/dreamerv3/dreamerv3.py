...
class DreamerV3:
    ...
    def train_step(self, batch: dict[str, torch.Tensor]) -> dict[str, float]:
        ...
        reward_logits = wm_out["reward_logits"]
        reward_target = reward[:, :reward_logits.shape[1]]
        ...
        continue_logits = wm_out["continue_pred"]
