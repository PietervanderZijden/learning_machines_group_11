...
def load_config(config_path):
    ...
    conf.BasicSettings.Base = ""
    conf.BasicSettings.Environment = ""
    conf.BasicSettings.n = ""
    conf.BasicSettings.config_path = ""
    conf.BasicSettings.env_name = ""
    conf.BasicSettings.trajectory_path = ""
    conf.BasicSettings.pretrained_path = None
    conf.BasicSettings.silent = False
    ...
    conf.JointTrainAgent.ModelType = ""
